--------------------------------------------------------------------------------
Profile data file 'callgrind.out.5497' (creator: callgrind-3.22.0)
--------------------------------------------------------------------------------
I1 cache: 
D1 cache: 
LL cache: 
Timerange: Basic block 0 - 435006551
Trigger: Program termination
Profiled target:  ./a.out (PID 5497, part 1)
Events recorded:  Ir
Events shown:     Ir
Event sort order: Ir
Thresholds:       99
...
Ir                     
--------------------------------------------------------------------------------
4,223,134,779 (100.0%)  PROGRAM TOTALS

--------------------------------------------------------------------------------
Ir                      file:function
--------------------------------------------------------------------------------
3,520,000,000 (83.35%)  spisok.cpp:Init_Spisok(str_spisok*) [/mnt/c/Users/Дима/Desktop/C/HashTable/a.out]
   96,051,542 ( 2.27%)  ./malloc/./malloc/malloc.c:_int_malloc [/usr/lib/x86_64-linux-gnu/libc.so.6]
   86,020,464 ( 2.04%)  hash_funcs.cpp:Hash_crc32(char*) [/mnt/c/Users/Дима/Desktop/C/HashTable/a.out]
   77,602,826 ( 1.84%)  hash_table.cpp:Read_Test_Words() [/mnt/c/Users/Дима/Desktop/C/HashTable/a.out]
   ...
   63,051,527 ( 1.49%)  hash_table.cpp:Find_Word(str_spisok*, char*) [/mnt/c/Users/Дима/Desktop/C/HashTable/a.out]
   52,640,988 ( 1.25%)  ./string/../sysdeps/x86_64/multiarch/strcmp-avx2.S:__strcmp_avx2 [/usr/lib/x86_64-linux-gnu/libc.so.6]
   39,647,291 ( 0.94%)  ./malloc/./malloc/malloc.c:_int_free [/usr/lib/x86_64-linux-gnu/libc.so.6]
   ...
   17,679,952 ( 0.42%)  hash_table.cpp:Word_In_List(str_spisok, char*) [/mnt/c/Users/Дима/Desktop/C/HashTable/a.out]
   15,542,742 ( 0.37%)  ./malloc/./malloc/malloc.c:free [/usr/lib/x86_64-linux-gnu/libc.so.6]
   12,794,476 ( 0.30%)  ./string/../sysdeps/x86_64/multiarch/strlen-avx2.S:__strlen_avx2 [/usr/lib/x86_64-linux-gnu/libc.so.6]
    9,981,752 ( 0.24%)  /usr/lib/gcc/x86_64-linux-gnu/13/include/smmintrin.h:Hash_crc32(char*)
...
-- line 816 ----------------------------------------
        ...
        .           {
5,733,580 ( 0.14%)    return __builtin_ia32_crc32qi (__C, __V);
        .           }
        .           
        .           extern __inline unsigned int __attribute__((__gnu_inline__, __always_inline__, __artificial__))
        ...
        .           {
4,248,172 ( 0.10%)    return __builtin_ia32_crc32si (__C, __V);
        .           }
        .           
        .           #ifdef __x86_64__
...
3,523,808,000 (83.44%)  => /mnt/c/Users/Дима/Desktop/C/HashTable/spisok.cpp:Init_Spisok(str_spisok*) (4,000x)
         .           
       ...
       873 ( 0.00%)  => ???:0x0000000000109150 (1x)
         .           
 1,480,424 ( 0.04%)      for (int i = 0; i < SIZE_TEST_FILE; i++, massive++)
         .               {
...
11,681,163 ( 0.28%)  => ???:0x00000000001091e0 (1,297,907x)
 ...
 2,713,300 ( 0.06%)  {
 3,659,584 ( 0.09%)      for (int i = 1; i <= spisok.size; i++)
         .               {
 9,152,916 ( 0.22%)          if (strcmp(spisok.data[i], word) == 0)
19,118,942 ( 0.45%)  => ???:0x00000000001091b0 (762,743x)
...
55,635,239 ( 1.32%)  => /mnt/c/Users/Дима/Desktop/C/HashTable/hash_funcs.cpp:Hash_crc32(char*) (370,105x)
         .           
22,806,313 ( 0.54%)      for (int i = 1; i <= mas_list[index_mas].size; i++)
30,239,960 ( 0.72%)          if (strcmp(mas_list[index_mas].data[i], word) == 0)
38,071,528 ( 0.90%)  => ???:0x00000000001091b0 (1,511,998x)
...
28,972,917 ( 0.69%)          for (int i = 0; isalpha(*massive); i++, massive++)
...
54,986,983 ( 1.30%)  => /mnt/c/Users/Дима/Desktop/C/HashTable/hash_funcs.cpp:Hash_crc32(char*) (542,660x)
         .           
 6,511,920 ( 0.15%)          index %= MASSIVE_SIZE;
         .           
14,651,820 ( 0.35%)          if (Word_In_List(mas_list[index], word))
36,798,894 ( 0.87%)  => hash_table.cpp:Word_In_List(str_spisok, char*) (542,660x)
         .                   {
...
55,774,099 ( 1.32%)  => ???:0x0000000000109130 (526,172x)
 ...
 1,834,109 ( 0.04%)  => /mnt/c/Users/Дима/Desktop/C/HashTable/spisok.cpp:Data_Vstavka(str_spisok*, int, char*) (16,488x)
         .               }
         5 ( 0.00%)  }
--------------------------------------------------------------------------------
...
-- line 13 ----------------------------------------
    ...
    1,260,000 ( 0.03%)  => ???:0x00000000001091a0 (4,000x)
       ...
       16,000 ( 0.00%)      IF_ERROR_CALLOC(spisok->prev);
            .           
  479,992,000 (11.37%)      for (int i = 1; i < SIZE_DATA - 1; i++)
1,439,928,000 (34.10%)          spisok->next[i] = i + 1;
            .           
  479,980,000 (11.37%)      for (int i = 2; i < SIZE_DATA - 1; i++)
1,119,916,000 (26.52%)          spisok->prev[i] = -1;
            .               
        4,000 ( 0.00%)      return 0;
        8,000 ( 0.00%)  }
            .           
      ...
      148,392 ( 0.00%)      if (spisok->prev[index] == -1)
       ...
       19,705 ( 0.00%)          spisok->head = spisok->free;
       50,188 ( 0.00%)      else if (index == spisok->tail)
    ...
    1,780,681 ( 0.04%)  => ???:0x0000000000109130 (16,488x)
      ...
      864,000 ( 0.02%)  => spisok.cpp:List_Destructor(str_spisok) (4,000x)
          ...
          469 ( 0.00%)  => ???:0x00000000001091f0 (1x)
            .           
       12,004 ( 0.00%)      for (int i = 0; i < MASSIVE_SIZE; i++)
       64,000 ( 0.00%)          fprintf(fp, "%d\n", mas_list[i].size);
    2,292,913 ( 0.05%)  => ???:0x00000000001091c0 (4,000x)
            .           
            3 ( 0.00%)      fclose(fp);
          695 ( 0.00%)  => ???:0x0000000000109160 (1x)
            3 ( 0.00%)  }
--------------------------------------------------------------------------------
...
14,620,006 ( 0.35%)  => ???:0x0000000000109170 (912,765x)
 5,476,590 ( 0.13%)      int count_cyc_1 = len / 4;
 7,302,120 ( 0.17%)      int count_cyc_2 = len % 4;
         .           
 9,874,040 ( 0.23%)      for (int i = 0; i < count_cyc_1; word += 4, i++)
         .               {
24,426,989 ( 0.58%)          int words_4 = (*word << 24) | (*(word+1) << 16) | (*(word+2) << 8) | *(word+3);
 5,310,215 ( 0.13%)          crc = _mm_crc32_u32(crc, (unsigned)words_4);
         .               }
         .           
11,730,800 ( 0.28%)      for (int i = 0; i < count_cyc_2; word ++, i++)
10,033,765 ( 0.24%)          crc = _mm_crc32_u8(crc, (unsigned char)*word);
         .           
...
Ir                     
--------------------------------------------------------------------------------
3,878,611,207 (91.84%)  events annotated
